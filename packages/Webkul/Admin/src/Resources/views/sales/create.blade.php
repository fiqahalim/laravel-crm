...
@section('page_title')
    {{ __('admin::app.sales.create-title') }}
@stop

@section('content-wrapper')
    @php
        $sale = app('\Webkul\Quote\Repositories\QuoteRepository')->getModel();
    ...
    <div class="content full-page adjacent-center">
        {!! view_render_event('admin.sales.create.header.before') !!}
        ...
        <div class="page-header">
            ...
            <div class="page-title">
                <h1>{{ __('admin::app.sales.create-title') }}</h1>
            </div>
        </div>

        {!! view_render_event('admin.sales.create.header.after') !!}

        <form method="POST" action="{{ route('admin.sales.store') }}" @submit.prevent="onSubmit" enctype="multipart/form-data">
