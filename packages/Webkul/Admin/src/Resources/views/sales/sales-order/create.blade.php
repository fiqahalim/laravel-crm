...
@section('page_title')
    {{ __('admin::app.sales.sales-order.create-title') }}
@stop
...
@section('content-wrapper')
    ...
    <div class="content full-page adjacent-center">
        {!! view_render_event('admin.sales-order.create.header.before') !!}

        <div class="page-header">

            {{ Breadcrumbs::render('sales-order.create') }}

            <div class="page-title">
                <h1>{{ __('admin::app.sales.sales-order.create-title') }}</h1>
            </div>
        </div>

        {!! view_render_event('admin.sales-order.create.header.after') !!}

        <form method="POST" action="{{ route('admin.sales-order.store') }}" @submit.prevent="onSubmit" enctype="multipart/form-data">
