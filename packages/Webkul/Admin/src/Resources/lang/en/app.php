    ...
    return [
        ...
        'layouts' => [
            ...
            'sales'                 => [
                ...
                'ship-order'   => 'Shipping Order',
                'sale-invoice'   => 'Collective Invoicing (Sales)',
            ],
            'purchases'            => 'Purchases',
            'reports'              => 'Reports',
            ...
            'settings'             => 'Settings',
            'user'                 => 'Employee',
            'user-info'            => 'Manage all your employees and their permissions in the CRM, what they’re allowed to do.',
            'groups'               => 'Groups',
            ...
            'users'                => 'Employees',
            'users-info'           => 'Add, edit or delete employees from CRM',
            'lead'                 => 'Lead',
            ...
            'currencies-info'      => 'Add, edit or delete foreign currency',
        ...
        'quotes' => [
            ...
            'delete-failed'       => 'Quotation can not be deleted.',
        ...
        'sales' => [
            'title'               => 'Sales',
            'sale'                => 'Sale',
            'sale-list'           => 'Sales List',
            'sale-date'           => 'Date',
            'sale-pic'            => 'PIC',
            'sale-transaction'    => 'Transaction Type',
            'job-ref-no'          => 'Job Ref. No.',
            'sale-no'             => 'Sales No',
            'cust-vendor'         => 'Customer/Vendor',
            'location-out'        => 'Location-Out',
            'currency'            => 'Currency',
            'terms'               => 'Terms',
            'create-title'        => 'New Sales',
            'edit-title'          => 'Edit Sales',
            'save-btn-title'      => 'Save Sales',
            'back'                => 'Back',
            'cancel'              => 'Cancel',
            'approved'            => 'Approval',
            'item-code'           => 'Item Code',
            'item-name'           => 'Item Name',
            'specs'               => 'Spec.',
            'additional-spec'     => 'Additional Spec.',
            'remarks'             => 'Remarks',
            'quantity'            => 'Qty.',
            'price'               => 'Price',
            'pretax-amount'       => 'Pretax Amount',
            'tax'                 => 'Tax',
            'serial-lot-no'       => 'Serial/Lot No',
            'price_tax'           => 'Price (Tax included)',
            'tracking-no'         => 'Tracking No.',
            'total-amount'        => 'Total Amount',
            'location-code'       => 'Location Code',
            'invoicing-status'    => 'Invoicing Status',
            'loaded-slip'         => 'Loaded Slip',
            'change-sale'         => 'Change Sales Price-Batch',
            'receipt-status'      => 'Receipt Status',
            'create-success'      => 'New Sales created successfully.',
            'update-success'      => 'Sales updated successfully.',
            'delete-success'      => 'Sales deleted successfully.',
            'delete-failed'       => 'Sales can not be deleted.',
            'sales-order'   => [
                'title'               => 'Sales Order',
                'create-title'        => 'New Sales Order',
                'edit-title'          => 'Edit Sales Order',
                'save-btn-title'      => 'Save Sales Order',
            ],
        ],
        ...
        'mail' => [
            ...
            'user' => [
                'create-subject'    => 'You are added as a PIC/Employee.',
        ...
        'settings' => [
            ...
            'users' => [
                ...
                'status'              => 'Status',
                'save-btn-title'      => 'Save as Employee',
                ...
                'delete-failed'       => 'Employee can not be deleted.',
                'user-define-error'   => 'Can not delete system employee.',
                'last-delete-error'   => 'At least one employee is required.',
                'user-define-error'   => 'Can not delete system user.',
                'mass-update-success' => 'Employees updated successfully.',
                'mass-update-failed'  => 'Employees can not be updated.',
                'mass-delete-success' => 'Employees deleted successfully.',
                'mass-delete-failed'  => 'Employees can not be deleted.',
            ],
